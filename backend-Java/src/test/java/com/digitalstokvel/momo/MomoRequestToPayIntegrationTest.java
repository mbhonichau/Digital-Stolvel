...
@ActiveProfiles("dev")
@Transactional
class MomoRequestToPayIntegrationTest {
    ...
    void setUp() {
        ...
        member = memberRepository.save(new Member(
                "+27812345678", "Kagiso", "Rabada", "kagiso@example.com"
        ));
    ...
    @Test
    @DisplayName("Should trigger MTN MoMo Request-To-Pay when creating contribution with paymentMethod MOMO")
    void testMoMoRequestToPayTriggered() throws Exception {
        CreateContributionRequest request = new CreateContributionRequest(
                ...
                "ZAR",
                PaymentMethod.MOMO,
                null, // reference will be auto-populated by MTN MoMo call
        ...
        mockMvc.perform(post("/contributions")
                ...
                .andExpect(jsonPath("$.data.paymentMethod", equalTo("MOMO")))
