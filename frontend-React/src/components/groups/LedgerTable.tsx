            ...
            return (
              <div key={item.id} className="py-3.5 flex items-center justify-between gap-2.5">
                <div className="flex items-center gap-2.5 min-w-0 flex-1">
                  <HexAvatar name={item.displayName || item.memberName || 'Member'} size="sm" />
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-bold text-mtn-cream truncate">{item.displayName || item.memberName || 'Member'}</p>
